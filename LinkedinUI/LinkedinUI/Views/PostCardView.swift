...
let samplePostData = PostData(id: 1, image: "1", title: "Gaurav Semwal", followers: 5, profileImage: "1")
...
struct PostCardView: View {
    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            Text("Looking for a new course on iOS swift UI, you are already on it.")
            Image(data.image)
                .resizable()
                .aspectRatio(contentMode: .fit)
